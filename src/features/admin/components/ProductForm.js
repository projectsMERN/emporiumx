...
function ProductForm() {
  ...
  const colors = [
    ...
    },
    {
      name: 'Pink',
      class: 'bg-pink-900',
      selectedClass: 'ring-pink-900',
      id: 'pink',
    },
    {
      name: 'Brown',
      class: 'bg-brown-900',
      selectedClass: 'ring-brown-900',
      id: 'brown',
    },
  ];
  ...
  useEffect(() => {
    if (selectedProduct && params.id) {
      ...
      setValue(
        'sizes',
        selectedProduct.sizes.map((size) => size.id).join(' ')
      );
      setValue(
        'colors',
    ...
    <>
      <form
        ...
        onSubmit={handleSubmit((data) => {
          ...
          if (product.sizes) {
            product.sizes = product.sizes.split(' ').map((size) => ({ id: size, name: size }));
          }
