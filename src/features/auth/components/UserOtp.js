...
const UserOtp = () => {
  ...
  return (
    ...
    {user && <Navigate to="/home" replace={true}></Navigate>}
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8" style={{ backgroundColor:"#220043" }}>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form
            ...
            onSubmit={handleSubmit((data) => {
              dispatch(
                loginUserAsync({ email: email, password: data.password })
              );
            })}
            className="space-y-6"
          >
